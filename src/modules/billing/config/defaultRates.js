export const DEFAULT_RATES = [
  ...
  { ruleId: 'unified_report_legal_monthly', name: "Об'єднана звітність (ЄСВ + 4-ДФ) — юридичні", price: 250, active: true, autoInclude: true },
  { ruleId: 'unified_report_fop_quarterly', name: "Об'єднана звітність (ЄСВ + 4-ДФ) — ФОП",      price: 250, active: true, autoInclude: true },
